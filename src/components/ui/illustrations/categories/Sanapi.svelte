<svg width="64" height="64" viewBox="0 0 64 64" fill="none">
  <path
    class="fill-[var(--athens,#F3F4FA)] group-hover:fill-[var(--green-light-1,#EDF8F5)]"
  ...
  <path
    class="fill-[var(--casper,#9FAAC4)] group-hover:fill-[var(--blue,#5275FF)]"
  ...
  <path
    class="fill-[var(--waterloo,#7A859E)] group-hover:fill-[var(--orange-hover,#FD9317)]"
