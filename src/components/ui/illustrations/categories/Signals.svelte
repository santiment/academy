<svg width="160" height="120" viewBox="0 0 160 120" fill="none">
  <circle
    ...
    cy="60"
    r="55"
    class="stroke-[var(--athens,#F3F4FA)] group-hover:stroke-[var(--blue-light-1,#ECF0FE)]"
    stroke-width="4"
  />
  ...
  <circle
    ...
    cy="52"
    r="39"
    class="fill-[var(--athens,#F3F4FA)] group-hover:fill-[var(--blue-light-1,#ECF0FE)]"
  />
  ...
  <path
    class="fill-[var(--fiord,#505573)] group-hover:fill-[var(--blue,#5275FF)]"
    fill-rule="evenodd"
  ...
  <path
    class="fill-[var(--fiord,#505573)] group-hover:fill-[var(--green,#14C393)]"
    fill-rule="evenodd"
  ...
  <path
    class="stroke-[var(--casper,#9FAAC4)] group-hover:stroke-[var(--green,#14C393)]"
    stroke-width="1.5"
  ...
  <path
    class="stroke-[var(--casper,#9FAAC4)] group-hover:stroke-[var(--orange-hover,#FD9317)]"
    stroke-width="1.5"
