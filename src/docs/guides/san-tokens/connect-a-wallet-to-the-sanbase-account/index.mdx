...
sidebarLabel: Connect a wallet to the Sanbase Account
sidebarOrder: 20
---
...
<Notebox type="pin">
  ...
  possession. Please refer to [this article](/guides/san-tokens/how-to-buy-san-tokens/)
...
This procedure is described in the article [Logging into Sanbase](/guides/sanbase/logging-into-sanbase/). Please refer to this resource as needed.
...
💰 [How to Buy SAN Tokens](/guides/san-tokens/how-to-buy-san-tokens)
