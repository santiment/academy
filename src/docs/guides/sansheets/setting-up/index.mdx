...
To fully utilize Sansheets, you will eventually need to use an API key. Learn [how to create an API key](/guides/products-and-plans/create-an-api-key) and [how to add it to Sansheets](/guides/sansheets/adding-an-api-key) by following these guides.
