...
- The total [development activity](/resources/metrics/development-activity/development-activity/) for the past 30 days.
...
<Notebox type="none">**Read next: [Rate Limits](/guides/sanapi/rate-limits)**</Notebox>
