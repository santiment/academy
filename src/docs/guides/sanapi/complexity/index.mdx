...
API queries for metrics, such as [this NVT example](/resources/metrics/nvt#sanapi), can
...
**Read next: [Supported Blockchains](/guides/sanapi/supported-blockchains)**
