...
You can find the documentation for most of the metrics on [this page](/resources/metrics).
...
- `ANY` - Any value within the interval. This is typically used when all values
  ...
  [Santiment Queries](/guides/santiment-queries) product.
...
**Read next: [Common GraphQL Queries](/guides/sanapi/common-queries)**
