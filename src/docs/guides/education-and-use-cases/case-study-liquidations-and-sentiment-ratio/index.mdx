...
RECHECK SIDEBAR ORDER FOR EDUCATION

### Metrics

`Total Liquidations`, and `Total Stablecoin Debt` combined metric for [multiple defi protocols](https://academy.santiment.net/resources/metrics/lending-and-borrowing-protocols)
