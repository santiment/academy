...
The [circulation metric](https://academy.santiment.net/resources/metrics/circulation/#definition) measures the number of unique coins or tokens being
...
use [transaction
volume](https://academy.santiment.net/guides/education-and-use-cases/trading-and-transaction-volume/).

Circulation shouldn’t also be used interchangeably with [Stock to Flow (S2F)
ratio](https://academy.santiment.net/resources/metrics/stock-to-flow/). S2F compares the
...
[Circulation | Santiment Academy](https://academy.santiment.net/resources/metrics/circulation/)
