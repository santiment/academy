...
export const GUIDES = [
  ...
  },
  {
    ...
    articles: ['Introduction', 'Exploration', 'Writing SQL Queries', 'API Access', 'Queries Restrictions', 'Prices', 'DEX Pools', 'NFT Tables', 'XRPL Tables'],
  },
  {
    title: 'SanAPI',
    icon: SanAPI,
    ...
    articles: ['Supported Blockchains', 'Fetching Metrics', 'Queries', 'Common Queries', 'Rate Limits', 'Complexity'],
  },
  {
    title: 'Sansheets',
    icon: Sansheets,
