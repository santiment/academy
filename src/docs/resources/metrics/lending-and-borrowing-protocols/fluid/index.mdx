...
* [Five-minute Intervals](/resources/metrics/details/frequency#five-minute-frequency) - Actions, supply and APY metrics
* [Daily Intervals](/resources/metrics/details/frequency#daily-frequency) - Active addresses metric
