...
- `mcd_locked_token` - The volume of collateral locked in Multi-Collateral DAI contracts,
  measured by a token<sup>[1]</sup>
- `mcd_liquidation` - Amount of liquidated tokens<sup>[2]</sup>
...
The following metrics have [Five-minute Intervals](/resources/metrics/details/frequency#five-minute-frequency)

- `mcd_supply` - [Five-minute Intervals](/resources/metrics/details/frequency#five-minute-frequency)

The rest of the metrics have [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
