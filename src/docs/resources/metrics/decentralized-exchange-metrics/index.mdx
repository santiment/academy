...
> framework ([Available DEXs for old framework](/resources/metrics/decentralized-exchange-metrics/old_dex_list)).
...
List of decentralized exchanges: [Available Decentralized Exchanges](/resources/metrics/decentralized-exchange-metrics/dex_list).
