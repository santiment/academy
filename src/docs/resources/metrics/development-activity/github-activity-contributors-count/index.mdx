...
- `github_activity_contributors_count` - [Five-Minute Intervals](/resources/metrics/details/frequency#five-minute-frequency)
- `github_activity_contributors_count_7d` - [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
- `ecosystem_github_activity_contributors_count_7d` - [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
