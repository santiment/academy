...
- `type` - Either [query](/guides/glossary/#query) or [metric](/guides/glossary/#metric)
- `name` - The name of the query or metric. Check the [query](/guides/glossary/#query) and [metric](/guides/glossary/#metric) definition and examples in order to understand what the name represents exactly.
