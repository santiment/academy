...
circulation](/resources/metrics/circulation) (**not** the [transaction
volume](/resources/metrics/transaction-volume)) **minus** the block rewards/uncle
rewards/mints.
...
[Histogram Data](/resources/metrics/details/data-type#histogram-data)
