...
also by using [Circulation](/resources/metrics/circulation) instead, which filters out
...
[Five Minute Intervals](/resources/metrics/details/frequency#five-minute-frequency) and [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
