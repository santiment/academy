...
[Realized Value](/resources/metrics/realized-value) against the [Total Circulating](/resources/metrics/circulation)
...
Mean Realized Price metric is also available for different [time bounds](/resources/metrics/details/timebound), which
