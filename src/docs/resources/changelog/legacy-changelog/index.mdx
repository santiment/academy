...
- New metrics:
  ...
  - The Ratio of Daily On-Chain Transaction Volume in Profit to Loss
    [https://academy.santiment.net/resources/metrics/transaction-volume-in-profit-or-loss](https://academy.santiment.net/resources/metrics/transaction-volume-in-profit-or-loss)
...
- **`Sanbase`**: We make fresh new chart's engine for our services. Now our charts become much faster. You can try it on our desktop web app - [https://app.santiment.net/](https://app.santiment.net/)
