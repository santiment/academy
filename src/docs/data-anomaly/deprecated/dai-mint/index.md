...
In order to identify "outstanding" mints the **99.9% rolling quantile over last 3000 mints** is computed. If the minted amount is greater than the computed value, it is marked as an "outstanding" value.
