...
Available under the `usdt_binance_open_interest` and `usdt_bnb_open_interest` names.
...
Available under the `usdt_binance_open_value` and `usdt_bnb_open_value` names.
