...
> previous names, listed here: [Deprecated MakerDAO metrics](/metrics/lending-and-borrowing-protocols/makerdao/deprecated_metrics). **Although 
> older data remains accessible through the API, we do not recommend its use.**
---
