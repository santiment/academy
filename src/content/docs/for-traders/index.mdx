...
Santiment is an all-in-one market behavior and intelligence platform for cryptocurrency traders. As a trader, our tools can help you identify, contextualize, and eventually - predict market behavior.
All Santiment tools and products serve a singular purpose - to help users understand the behavioral patterns and activities of market stakeholders.
...
You can find out more about our data feeds on the [SanAPI page](https://api.santiment.net?utm_source=academy).
...
Our [Social Trends tool](https://app.santiment.net/social-trends?utm_source=academy) lets you view any coin’s social volume over time to prove the effectiveness of this approach.
...
Many Bitcoin tops were accompanied by a significant drop in mean dollar age:

![](image2.png)

There are several examples of different Santiment metrics supporting top predictions.

### Articles About Spotting Tops

- [Social Trends](/sanbase/social-trends/) — How to use it, including spot local tops and hype peaks.
- [Getting started with Santiment](/santiment-introduction/) — Identifying Market Tops and Bottoms (Tops section covers how to spot tops).
- [Spot tops with Price and Network Activity divergences](/education-and-use-cases/how-to-spot-tops-with-price-network-activity-divergences/) — Using on-chain activity divergences to spot tops.
- [Case Study 3: Social Volume Indicates a Top](/education-and-use-cases/case-study-social-volume/) — Market analysis example focusing on social volume signaling a top.
- [Understanding Short-Term Market Trends](/education-and-use-cases/understanding-short-term-market-trends/) — Handbook aimed at identifying market tops using multiple indicators.
...
### Articles About Spotting Bottoms

- [Case Study 2: NRPL and 3y MVRV to Spot Macro Cycle Bottoms](/education-and-use-cases/case-study-nrpl-mvrv/) — A long-horizon example showing how large holders’ behavior and NRPL/3y MVRV signals were used to spot a macro bottom for BTC.
- [Spotting Market Bottoms with the Buy the Dip Query](/education-and-use-cases/understanding-market-expectations-through-historical-crypto-trends/) — This article explains spotting bottoms by tracking social mentions of “buy the dip”.
