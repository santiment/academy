...
Approximate transaction values are calculated by multiplying the amount of transferred coins by the closest coin's price value using price data with 5-minute intervals for each transaction.
