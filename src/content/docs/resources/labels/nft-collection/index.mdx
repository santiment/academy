...
NFT collections are usually identified by their [nft collection name](/resources/labels/nft-collection-name) and [nft collection symbol](/resources/labels/nft-collection-symbol). If the collection has a name or/and symbol that's easily accessible, we create labels for those too.
