...
NFT collections are usually identified by their [NFT collection name](/labels/nft-collection-name) and [NFT collection symbol](/labels/nft-collection-symbol). If the collection has a name and/or symbol that's easily accessible, we create labels for those too.
