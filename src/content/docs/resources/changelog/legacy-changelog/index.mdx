...
- **`Sanbase`**: It's time to pay with crypto for our tools. [https://app.santiment.net/pricing](https://app.santiment.net/pricing)
...
- **`Sanbase`**: We made a fresh new chart engine for our services. Now our charts are much faster. You can try it on our desktop web app - [https://app.santiment.net/](https://app.santiment.net/)
