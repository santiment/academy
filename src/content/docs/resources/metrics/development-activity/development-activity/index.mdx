...
- `dev_activity` - [Five-Minute Intervals](/resources/metrics/details/frequency#five-minute-frequency)
- `dev_activity_1d` - [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
- `ecosystem_dev_activity` - [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
