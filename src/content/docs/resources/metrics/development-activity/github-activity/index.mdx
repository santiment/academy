...
- `github_activity` - [Five-Minute Intervals](/resources/metrics/details/frequency#five-minute-frequency)
- `github_activity_1d` - [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
- `ecosystem_github_activity` - [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
