...
- [Github Activity](/resources/metrics/development-activity/github-activity/) - Count all
  events for a project.
- [Github Activity Contributors Count](/resources/metrics/development-activity/github-activity-contributors-count) -
