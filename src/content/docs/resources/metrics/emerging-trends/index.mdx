...
word that is present in the [social data](/resources/metrics/details/social-data/) after filtering
...
The metric's historical data is with [restricted access](/resources/metrics/details/access#restricted-access).
...
- $v_i^n$ is the _normalized_ social volume of the word at the moment $i$ (i.e.
  the usual [social volume](/resources/metrics/social-volume)
  divided by the total amount of messages in that particular [data
  source](/resources/metrics/details/social-data/)),
...
Emerging Trends are available at [hourly intervals](/resources/metrics/details/frequency#hourly-frequency)

---

## Latency

Emerging Trends have [social data Latency](/resources/metrics/details/latency#social-data-latency)

---

## Available Assets

The algorithm takes into account all the [social data](/resources/metrics/details/social-data/),
