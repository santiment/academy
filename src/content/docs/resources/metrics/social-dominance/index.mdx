...
The metric is build on top of the [Social Data](/resources/metrics/details/social-data).
...
Volume](/resources/metrics/social-volume) of that asset to the combined social volume of the
...
Volume](/resources/metrics/social-volume) of that search term to the total number of
