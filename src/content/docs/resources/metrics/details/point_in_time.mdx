...
description: 'Explains how Santiment’s point-in-time social metrics preserve immutable historical data to prevent look-ahead bias, including the cutoff rules, computation process, supported sources and metrics, risks, and API versioning required to query them.'
