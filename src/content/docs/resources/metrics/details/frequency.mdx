...
Example: The emerging trends are computed for every round hour in a day.

## Eight-hour frequency

One value is computed for every eight hours of the day.

Example: The Binance funding rate metrics are computed once every eight hours in a day.
