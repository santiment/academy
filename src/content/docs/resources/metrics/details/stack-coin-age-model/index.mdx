...
and CEO, had asked him if it was possible to develop an Ethereum and ERC20
equivalent to the _Bitcoin-days destroyed_ metric. Milan, Tzanko and Valentin
from [Santiment](https://santiment.net?utm_source=academy) optimized the calculations and used the
