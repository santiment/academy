...
Social Volume is build on top of the [Social Data](/resources/metrics/details/social-data).

The total number of [social data text documents](/resources/metrics/details/social-data) that
...
Social Volume can be computed for an [asset](/guides/glossary#asset) or for arbitrary
