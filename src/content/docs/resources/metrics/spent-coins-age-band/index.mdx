...
Assigning age to coin/tokens is done according to the [coin-age model](/resources/metrics/details/stack-coin-age-model).
...
[Interval Timebound Metrics](/resources/metrics/details/interval_timebound) available
