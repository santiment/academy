...
pairs. When open interest reaches unusually high numbers, it can precede increased volatility in the coin's price.

Open Value shows the value of the corresponding open interest in Satoshis (XBT/BTC).

More details on the BitMEX [website](https://www.bitmex.com/app/contract/XBTUSD).
