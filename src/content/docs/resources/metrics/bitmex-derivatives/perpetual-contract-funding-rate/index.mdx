...
author: Anatoliy
description: BitMEX perpetual contract funding rate.
...
More details on the BitMEX [website](https://www.bitmex.com/app/perpetualContractsGuide#Mechanics-of-a-Perpetual-Contract-Market).
