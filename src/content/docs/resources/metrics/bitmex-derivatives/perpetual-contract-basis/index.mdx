...
Shows the difference between BitMEX [perpetual contract's price](/resources/metrics/bitmex-derivatives/perpetual-contract-price) of
 Project Ticker and BitMEX [index (spot) price](/resources/metrics/bitmex-derivatives/price-index) for Project Ticker.  
