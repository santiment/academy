...
particular day for a given asset. Refer to a [deposit address explanation here](/resources/labels/deposit)
...
metrics](/resources/metrics/exchange-funds-flow/) -- which shows the total amount of
...
For an exchange-specific data please refer to [that page](/resources/metrics/labeled-exchange)

---

## Access

The metric is with [restricted access](/resources/metrics/details/access#restricted-access).
...
Daily Active Deposits has [on-chain Latency](/resources/metrics/details/latency#on-chain-latency)
