...
- `eth2_stakers_realized_value_usd_<timebound>` - [Realized value](/resources/metrics/realized-value) of stakers addresses.
  Metric is available for different [time bounds](/resources/metrics/details/timebound).
- `eth2_stakers_mvrv_usd_<timebound>` - [MVRV](/resources/metrics/mvrv) of stakers addresses.
  Metric is available for different [time bounds](/resources/metrics/details/timebound).
