...
- transaction_volume - [Five-Minute Intervals](/resources/metrics/details/frequency#five-minute-frequency)
- transaction_volume_usd - [Daily Intervals](/resources/metrics/details/frequency#daily-frequency)
