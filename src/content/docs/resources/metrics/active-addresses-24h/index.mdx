...
asset in the past 24-hour window. Each address is counted only once for the
...
Daily Active Addresses metric is computed on whole days only - it counts the active
