...
generated for blocks 1 and 2 is $10 + 10 = 20$, but we can easily see that the
...
_In order to understand how all this can be tracked, you should read [the article about the token age consumed](/metrics/age-consumed/age-consumed-technical)._
...
[/metrics/details/stack-coin-age-model/](/metrics/details/stack-coin-age-model/). In this
