...
_In order to understand how all this can be tracked, you should read [the article about the token age consumed](/resources/metrics/age-consumed/age-consumed-technical)._
...
[https://academy.santiment.net/resources/metrics/details/stack-coin-age-model/](https://academy.santiment.net/resources/metrics/details/stack-coin-age-model/). In this
