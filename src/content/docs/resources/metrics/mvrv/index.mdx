...
- `MV` as in `Market Value` refers to the well-known capitalization. The second
  part is the
- `RV` as in [Realized Value](/resources/metrics/realized-value). It is an alternative to
...
[Timebound Metrics](/resources/metrics/details/timebound) available.
...
Intervals](/resources/metrics/details/frequency#daily-frequency) A subset of the available
assets that consists of some of the bigger assets have [Five-Minute
Intervals](/resources/metrics/details/frequency#five-minute-frequency)
