...
The Sentiment Bullish, Sentiment Bearish, and Sentiment Neutral metrics represent the sum of [Sentiment Bullish Bearish Score](/resources/metrics/sentiment-metrics/#bullish-bearish-sentiment-score) values.
