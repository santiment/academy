...
For more info, read the [A Primer on On-chain Trading Strategies](/guides/education-and-use-cases/price-to-daily-addresses-divergence---primer-on-on-chain-trading-strategies) article.
