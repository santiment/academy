...
The old metrics will stop being computed and will be removed.
...
- `mcd_collat_ratio_weth` - Shows the collateralization ratio of MCD collateral tokens.
