...
- `uniswap_user_claims_amount` - The amount of tokens claimed by users
- `uniswap_lp_claims_amount` - The amount of tokens claimed by liquidity providers
...
- `uniswap_claims_count` - The number of claims by both users and liquidity providers
...
Metrics that have `amount` in the name represent the number of tokens.
Metrics that have `count` in the name represent the number of claims.
Metrics that have `percent` in the name represent the percentage.
