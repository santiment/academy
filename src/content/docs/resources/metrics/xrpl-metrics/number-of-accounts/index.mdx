...
- **Total number of accounts** - [Daily frequency](/resources/metrics/details/frequency/#daily-frequency)
- **Number of active accounts** - [Five-Minute Intervals](/resources/metrics/details/frequency#five-minute-frequency)
- **Number of accounts with minimum reserves** - [Daily frequency](/resources/metrics/details/frequency/#daily-frequency)
