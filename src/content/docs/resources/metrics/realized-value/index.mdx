...
according to the [coin-age model](/resources/metrics/details/stack-coin-age-model).

Realized Value metric is also available for different [time bounds](/resources/metrics/details/timebound), which
