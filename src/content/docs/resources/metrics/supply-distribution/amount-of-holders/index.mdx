...
- `holders_distribution_<interval>` - The number of addresses holding tokens within a specified balance [interval](/resources/metrics/details/supply_distribution_parameters#available-intervals)
- `percent_of_holders_distribution_<interval>` - The percentage of addresses within a specified balance [interval](/resources/metrics/details/supply_distribution_parameters#available-intervals)
- `holders_distribution_over_<threshold>` - The number of addresses with balances exceeding a specified balance [threshold](/resources/metrics/details/supply_distribution_parameters#available-thresholds)
