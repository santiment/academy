...
- `holders_distribution_combined_balance_<interval>` - Total tokens held by all addresses within a
  specified balance [interval](/resources/metrics/details/supply_distribution_parameters#available-intervals)
- `percent_of_holders_distribution_combined_balance_<interval>` - The percentage of tokens held by
  all addresses within a specified balance [interval](/resources/metrics/details/supply_distribution_parameters#available-intervals)
- `holders_distribution_combined_balance_over_<threshold>` - Total tokens held by all addresses with balances
  exceeding a specified balance [threshold](/resources/metrics/details/supply_distribution_parameters#available-thresholds)
