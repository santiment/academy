...
Funding rates aggregated metrics use [Open Interest](/resources/metrics/open-interest) for aggregation. Meaning the contract with the biggest open interest will have the biggest impact on the final funding rate aggregated value.
...
[On-Chain Latency](/resources/metrics/details/latency#funding-rates-latency)
