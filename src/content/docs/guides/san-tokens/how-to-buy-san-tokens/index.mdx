...
Now, simply [log in with a MetaMask](https://app.santiment.net/login) account that holds SAN tokens. Alternatively, you can [connect your Sanbase account](/guides/san-tokens/connect-a-wallet-to-the-sanbase-account) with your MetaMask wallet in the settings.
...
🔮 [Connect a wallet to the Sanbase account](/guides/san-tokens/connect-a-wallet-to-the-sanbase-account/)

💎 [SAN tokens holding benefits](/guides/san-tokens/san-tokens-holding-benefits)
