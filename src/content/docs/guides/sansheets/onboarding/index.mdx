...
Note that you may also refer to our helpful Github Sansheets function repository to find additional info on functions to pull data for any of your favorite metrics: [https://github.com/santiment/google-spreadsheet-addon/blob/master/doc/sheet_functions.md](https://academy.santiment.net/guides/sansheets/functions/)
