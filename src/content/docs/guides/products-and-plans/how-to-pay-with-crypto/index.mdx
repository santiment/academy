...
sidebarLabel: 'How to pay with crypto'
sidebarOrder: 50
---
...
_[Make use of your SAN tokens for a hefty discount](/guides/products-and-plans/how-to-pay-with-crypto/#burning-san-tokens-to-make-payments)._
...
- [How to sign up/sign in with Metamask](/guides/sanbase/logging-into-sanbase/#first-login-using-metamask)
- [How to connect your wallet to an existing account](/guides/san-tokens/how-to-stake-san/#connecting-a-wallet-to-an-already-existing-account)
