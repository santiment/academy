...
All of our current products use the [Sanbase](https://app.santiment.net) account as a reference. You cannot use Sanbase as a login option for the API or for Sansheets. This is where an API key comes in.
