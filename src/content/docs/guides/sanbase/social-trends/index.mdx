...
identification of underlying factors, and studying trend changes and how
...
The Social Trends functionality consists of 5 tools:
...
hourly `Top 10` trending words related to crypto, sourced from more than 6,000
...
The results are sourced from more than 6,000 crypto-specific social media
channels, including:
...
Using [social volume](/metrics/social-volume)
and the number of unique authors, we rank words by popularity in social media at the
moment.
...
at their price peaks and then profit from the downside effectively. You can learn more by
reading [this
...
Sentiment](/metrics/sentiment-metrics/#sentiment-analysis)
...
The methodology for the bullish, neutral, or bearish meters is based on a custom BERT-like
...
On the page you can see the [social volume](/metrics/social-volume/) chart of this
trend, on which you can overlay the [social dominance chart](/metrics/social-dominance/#definition), the
...
Below you can see the dynamics of [social volume](/metrics/social-volume/) change by social
