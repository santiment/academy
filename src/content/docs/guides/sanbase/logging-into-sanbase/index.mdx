...
sidebarLabel: Logging into Sanbase
sidebarOrder: 50
---
...
For more information about the 'Account Settings' page, please refer to [this article](/guides/sanbase/account-settings).
...
You are now prepared to stake SAN tokens in order to avail discounts on your access plan. To learn how to stake SAN tokens, please refer to [this article](/guides/san-tokens/connect-a-wallet-to-the-sanbase-account).

If you need assistance on how to purchase SAN tokens initially, you can find guidance in [this article](/guides/san-tokens/how-to-buy-san).
