...
<video autoplay loop muted playsinline>
  <source src="./changeasset.mp4" type="video/mp4" />
</video>
...
<video autoplay loop muted playsinline>
  <source src="./displaysettingsnewcharts.mp4" type="video/mp4" />
</video>
...
<video autoplay loop muted playsinline>
  <source src="./timelineslider.mp4" type="video/mp4" />
</video>
...
<video autoplay loop muted playsinline>
  <source src="./chrome_2026-01-26_10-36-18.mp4" type="video/mp4" />
</video>

**Former add metric flow vs new add metric flow**

<video autoplay loop muted playsinline>
  <source src="./formervsnewmetricsadd.mp4" type="video/mp4" />
</video>

**Former chart display settings vs new chart display settings**

<video autoplay loop muted playsinline>
  <source src="./formervsnewchartdisplay.mp4" type="video/mp4" />
</video>
