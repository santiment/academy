...
The [circulation metric](/metrics/circulation/#definition) measures the number of unique coins or tokens being
...
day, it will be counted once by the token circulation, but 5 times if we were to
use [transaction
...
ratio](/metrics/stock-to-flow/). S2F compares the
...
[Circulation | Santiment Academy](/metrics/circulation/)
