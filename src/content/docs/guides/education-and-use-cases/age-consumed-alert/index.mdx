...
date: 2022-03-22
sidebarLabel: Alerts - Age Consumed
sidebarOrder: 10
---
...
The [Token Age Consumed metric](https://academy.santiment.net/resources/metrics/age-consumed/#definition) monitors the activity of coins based on the duration they have remained in their current wallets. Spikes on the chart represent the movement of previously idle coins, which could be owned by long-term HODLers or even ICO investors.
