...
[**Age Consumed**](https://academy.santiment.net/resources/metrics/age-consumed) or Token Age Consumed(TAC) is a reliable on-chain indicator that signals changes in market conditions. This metric assigns higher value to coins that have been held for a longer duration, compared to those recently acquired.
