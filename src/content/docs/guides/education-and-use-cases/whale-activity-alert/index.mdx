...
date: 2022-04-04
sidebarLabel: Alerts - Whale Activity
sidebarOrder: 30
---

Whale activity consists of several related metrics; [Whale transaction volume](https://academy.santiment.net/resources/metrics/whale-transaction-volume/), [Whale transaction count](https://academy.santiment.net/resources/metrics/whale-transaction-count/#description), [Combined Balance of Holders](https://academy.santiment.net/resources/metrics/supply-distribution/combined-balance-of-holders/), [Top Holders](https://academy.santiment.net/resources/metrics/top-holders/#top-holders-balance) and [Amount in Top Holders](https://academy.santiment.net/resources/metrics/amount-in-top-holders/). By closely monitoring the actions of major market players (which, depending on the asset, could be addresses worth $1M or more), you can gain insights to guide your own trading decisions.
