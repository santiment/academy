...
but usually) have some of the highest correlation with price movements.
...
about to change, check out the number of "whale transactions" that exceed a
...
To explore the data you can start a two-week free trial from [the pricing page](https://app.santiment.net/pricing?utm_source=academy)
