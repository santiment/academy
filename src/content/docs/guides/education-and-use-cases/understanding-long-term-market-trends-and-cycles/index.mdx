...
sidebar:
  label: Understanding Long-term Market Trends and Cycles
  order: 120
---
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/7UJIjj4uUPs?si=fyfKFHWSUO7_XdgV"
...
The key metric on chart 1 of the layout is age consumed, which represents amounts
...
inverse indicates that money isn't coming in. These metrics usually start falling around
the middle of the bull market, acting as a confirmation of strength. A change of
...
Dropping values show an inflow of new money, typically post-bull market midpoint, confirming market strength.

Rising values show a lack of new money, often predicting major market tops.
...
MVRV diverging from price can only be caused by the change in realized value.
