...
The [Table Engine](https://clickhouse.com/docs/en/engines/table-engines/) controls how data is stored, updated, and accessed. If the engine is \*MergeTree, then the `FINAL` keyword needs to be used. See the [Writing SQL Queries](/guides/santiment-queries/writing-sql-queries) page for more detailed examples and reasoning.
