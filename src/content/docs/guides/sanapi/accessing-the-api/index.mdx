...
- `429` - You're being rate-limited. Reduce the number of requests you're
  making. Check the [Rate limits](/guides/sanapi/rate-limits) page for more
  information.
...
[Historical and Realtime data restrictions](/guides/sanapi/historical-and-realtime-data-restrictions) are applied,
...
**Read next: [Fetching Metrics](/guides/sanapi/fetching-metrics)**
