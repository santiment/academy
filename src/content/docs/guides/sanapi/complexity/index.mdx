...
- Metric weight - **W**. Most metrics are stored in specialized fast data
  ...
  weight of 1.
- Weighted number of assets - **A**. When returning data for many assets (timeseriesDataPerSlugJson API),
  the number of assets multiplied by a weight of 0.1, minimum of 1. When returning
