...
Each [GraphQL Query](https://academy.santiment.net/guides/glossary/#query) is counted
...
**Read next: [Historical and Realtime data restrictions](/guides/sanapi/historical-and-realtime-data-restrictions)**
