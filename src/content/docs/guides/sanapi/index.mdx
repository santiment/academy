...
Instructions how to access the API can be found on the [Accessing the API](/guides/sanapi/accessing-the-api) page.

## Fetching Metrics

You can find information on how to explore and fetch the available metrics on the [Fetching Metrics](/guides/sanapi/fetching-metrics) page.

## Common GraphQL queries

The list of [Common GraphQL queries](/guides/sanapi/common-queries) gives examples for
the different type of queries one can craft and execute.

## Rate Limits

The [Rate Limits Page](/guides/sanapi/rate-limits) provides detailed information on
...
restrictions](/guides/sanapi/historical-and-realtime-data-restrictions) provides
...
[Complexity Page](/guides/sanapi/complexity) provides a detailed explanation on how
...
[glossary page](/guides/glossary).

## Supported Blockchains

You can find information about the blockchains we support on our [Supported
Blockchains page](/guides/sanapi/supported-blockchains).
