...
use a 7-day interval). The values show how many followers the project gained or
...
### Retrieve Current Trending Stories
...
<Notebox type="none">**Read next: [Rate Limits](/sanapi/rate-limits)**</Notebox>
