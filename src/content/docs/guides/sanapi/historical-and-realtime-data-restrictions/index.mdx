...
date: 2024-07-03
sidebarLabel: Historical and Realtime data restrictions
sidebarOrder: 50
---
...
data for the [metrics](/guides/sanapi/fetching-metrics).
...
Limits](/guides/sanapi/rate-limits) still apply and lower subscription plan users can
...
**Read next: [Complexity](/guides/sanapi/complexity)**
