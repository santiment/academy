...
author: Lyudmil
description: dYdX perpetual contract funding rate metric.
...
More details on the dYdX [website](https://help.dydx.exchange/en/articles/4797443-perpetual-funding-rate).
