...
- **Liquidity in XRPL AMM Pool by Pair** - the total amount of liquidity for a specific asset in a pool.
- **Liquidity in XRPL AMM Pool by Asset** - the total amount of tokens in all AMM pools for a specific asset.
...
Available under the `liquidity_in_amm_pools_by_pair` name.
