...
It is not uncommon for large inflows of tokens to the exchange to precede
rapid price growth.

Here is that exact scenario in the case of
...
When a large amount of tokens flows out of the exchange, on the other
