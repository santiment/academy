...
- circulation_3y - The number of tokens transacted at least once in the past 3
  years. If a coin/token is considered dead/lost (sent to a graveyard address, the
  owner lost the private key, etc.), such circulation can approximate total supply
