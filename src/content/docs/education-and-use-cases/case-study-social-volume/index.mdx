...
[Social Volume metric](/metrics/social-volume/#social-volume) + [Weighted Sentiment](/metrics/sentiment-metrics/weighted-sentiment-metrics/)
...
**Outcome:**
The token dropped over the next month by 41%, bottoming in late June 2025. Mark stayed on the lookout for a moment to reenter the position because of his long-term outlook on the project, mainly looking for bearish days with lower social volume since prices often rebounded in those scenarios.
