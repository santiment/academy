...
`Total Liquidations` and `Total Stablecoin Debt` combined metric for [multiple defi protocols](/metrics/lending-and-borrowing-protocols)
...
1. Big spikes of liquidations on falling price mean there is forced selling.
...
This combination of signals gave me the conviction to enter a position on Feb 28th at \$84,700 per BTC. I then proceeded to add more on March 9-10th at \$80,000 and \$79,300. Holding through the next dip early April was very scary, but the huge spike in liquidations and debt unwind confirmed that the price shouldn’t go much lower from there, as it indeed happened eventually.
