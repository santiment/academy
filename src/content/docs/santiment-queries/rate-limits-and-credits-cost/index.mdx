...
- [Sanbase pricing page](https://app.santiment.net/pricing?plans=individual&utm_source=academy)
- [Sanbase plans academy page](/products-and-plans/sanbase-plans/)

Check the plans and restrictions for **API** subscriptions on the:

- [API pricing page](https://app.santiment.net/pricing?plans=business&utm_source=academy)
