...
date: 2025-01-24
sidebarLabel: Santiment Introduction
sidebarOrder: 10
---
...
- [Screener](https://app.santiment.net/screener): Filter and compare assets according to the [Metrics](https://academy.santiment.net/resources/metrics/) you choose.
...
- [Negative Sentiment](/resources/metrics/sentiment-metrics/#what-is-sentiment):
  When the crowd is overly bullish, it can be a sign that a top is near.
  Santiment's [weighted sentiment
  metric](/resources/metrics/sentiment-metrics/weighted-sentiment-metrics/#definition)
...
- [Network Activity](/guides/education-and-use-cases/understanding-short-term-market-trends/#network-activity):
  Increased network activity, even during a price downturn, can indicate a
  potential bottom.

#### Monitoring Volatility

Metrics like [Token Age Consumed](/guides/education-and-use-cases/timing-market-volatility-with-token-age-consumed/)
alert you to potential trend reversals by tracking the movement of previously
idle coins.

#### Understanding Real-World Utility

[Transaction volume](/guides/education-and-use-cases/trading-and-transaction-volume/)
...
- [Chart Adjustments](/guides/sanbase/keyboard-shortcuts/#charts):
