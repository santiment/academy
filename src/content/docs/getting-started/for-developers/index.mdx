...
Apart from precomputed metrics, Santiment has the [Santiment Queries](/guides/santiment-queries)
...
or [execute the queries through the API](/guides/santiment-queries/api-access)
...
Queries](/guides/sanapi/common-queries) page, or read [How to access the
...
**Read more**: [Metrics Exported to S3 - Technical Documentation](/getting-started/for-developers/metrics-exported-s3)

## Metrics Catalog

There are a few different ways to explore the available metrics.

- Visit the [metrics' docs articles page](/resources/metrics) where you can find links to
...
**Read next: [How to Access the API](/guides/sanapi/accessing-the-api/)**
