...
query is self-descriptive and easy to maintain. New members of your team can
...
Queries](/sanapi/common-queries) page, or read the [How to Access the
...
- Visit the [metrics' docs articles page](/metrics) where you can find links to
  the documentation articles for the metrics.
