...
There are several examples of different Santiment metrics supporting top predictions. Check out the ‘Metrics’ tab on the Academy’s homepage for more use cases and metric tutorials.
