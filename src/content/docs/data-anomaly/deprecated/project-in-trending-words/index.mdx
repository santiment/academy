...
Once the signal is fired for some project the cooldown period of 12 hours is activated for this project. No new project-in-trending-words signals are emitted during the cooldown period.
